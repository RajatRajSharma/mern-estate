...
const UpdateListing = () => {
  ...
  return (
    <main className="p-3 max-w-4xl mx-auto">
      <h1 className="text-4xl italic text-slate-300 font-semibold text-center my-7">
        Update Listing
      </h1>
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          {formData.imageUrls.length > 0 &&
            formData.imageUrls.map((url, index) => (
              <div
                key={url}
                className="flex justify-between p-1 ps-4 border rounded-lg items-center"
              >
                <img
                  src={url}
                  alt="listing image"
                ...
                <button
                  ...
                  className="p-1 ps-2 pe-2 me-2 text-red-700 rounded-lg border border-red-400 uppercase hover:opacity-75"
                >
                  Delete
                </button>
              </div>
          ...
          <button disabled={loading || uploading} className="p-3 mt-5 bg-slate-600 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">
