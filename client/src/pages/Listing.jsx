      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className='fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer'>
            ...
            <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4' style={{marginBottom:"0px", paddingBottom:"5vh"}}>
            <p className='text-4xl font-semibold text-white italic'>
              {listing.name} - ${''}
              {listing.offer
            ...
            <p className='flex items-center mt-5 gap-2 text-slate-300 text-semibold text-lg'>
