      ...
      <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          <div className='flex items-center gap-2'>
            <label className='whitespace-nowrap text-white text-lg font-bold'>
              Search Term:
            </label>
            <input
              type='text'
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            <label className='text-white me-3 font-semibold'>Type:</label>
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            <label className='font-semibold me-3 text-white'>Amenities:</label>
            <div className='flex gap-2'>
              <input
                type='checkbox'
                id='parking'
          ...
          <div className='flex items-center gap-2'>
            <label className='font-semibold me-3 text-white'>Sort:</label>
            <select
              onChange={handleChange}
